	...
	<div id="wrapper">
        <div id="content">
            ...
            <div id="main">
				...
				<div class="container">
                    <?php
                        $products = mysqli_query($db_Connection, "SELECT * FROM Product  WHERE type = 'cosmetics' ORDER BY productName ASC") or die(mysql_error());
                        $numRecords = mysqli_num_rows($products);
                        echo "<form id='buyBody' name='buyBody' method='post' action='cosmeticsShowCase.php' enctype='multipart/form-data'>";
                        ...
                        { 
                            ...
                            if (isset($_POST['submit']))
                            {
                                ...
                                else
                                {
                                    ...
                                    echo "window.location = 'cosmeticsShowCase.php'";
                                    echo "</script>";
                                }
                            }
                        } 
