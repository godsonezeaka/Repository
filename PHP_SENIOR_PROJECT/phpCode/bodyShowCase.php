	...
	<div id="wrapper">
        <div id="content">
            ...
            <div id="main">
				...
				<div class="container">
                    <?php
                        $products = mysqli_query($db_Connection, "SELECT * FROM Product  WHERE type = 'body' ORDER BY productName ASC") or die(mysql_error());
                        $numRecords = mysqli_num_rows($products);
                        echo "<form id='buyBody' name='buyBody' method='post' action='bodyShowCase.php' enctype='multipart/form-data'>";
                        ...
                        { 
                            ...
                            if (isset($_POST['submit']))
                            {
                                ...
                                else
                                {
                                    ...
                                    echo "window.location = 'bodyShowCase.php'";
                                    echo "</script>";
                                }
                            }
                        } 
